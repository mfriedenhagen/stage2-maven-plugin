 ...
 *
 * @author Jason van Zyl @requiresProject false @goal copy2
 */
public class Copy2RepositoryMojo extends AbstractRepositoryMojo {
     ...
     *
     * @parameter default-value="${settings.offline}" @readonly
     */
    ...
    /**
     * Parameter used to control how many times a failed deployment will be retried before giving up and failing. If a value
     * outside the range 1-10 is specified it will be pulled to the nearest value within the range 1-10.
     *
    ...
    /**
     * Type of the artifact to be deployed. Retrieved from the &lt;packaging&gt element of the POM file if a POM file specified.
     * Defaults to the file extension if it is not specified via command line or POM.<br/> Maven uses two terms to refer to this
     * datum: the &lt;packaging&gt; element for the entire POM, and the &lt;type&gt; element in a dependency specification.
     *
     *
     ...
     * File to be deployed.
     *
     * @parameter expression="${file}" @required
     */
    private File file;
    /**
    ...
    /**
     * Server Id to map on the &lt;id&gt; under &lt;server&gt; section of settings.xml In most cases, this parameter will be
     * required for authentication.
     *
     * @parameter expression="${repositoryId}" default-value="remote-repository" @required
     */
     ...
     *
     * @parameter expression="${url}" @required
     */
    private String url;
    /**
    ...
    /**
     * A comma separated list of types for each of the extra side artifacts to deploy. If there is a mis-match in the number of
     * entries in {@link #files} or {@link #classifiers}, then an error will be raised.
     *
     * @parameter expression="${types}";
     */
    private String types;
    /**
     * A comma separated list of classifiers for each of the extra side artifacts to deploy. If there is a mis-match in the number
     * of entries in {@link #files} or {@link #types}, then an error will be raised.
     *
     * @parameter expression="${classifiers}";
     */
    private String classifiers;
    /**
     * A comma separated list of files for each of the extra side artifacts to deploy. If there is a mis-match in the number of
     * entries in {@link #types} or {@link #classifiers}, then an error will be raised.
     *
     ...
     *
     * @param artifact The artifact whose local repo path should be determined, must not be
     * <code>null</code>.
     *
     ...
     *
     * @param model The POM to extract missing artifact coordinates from, must not be
     * <code>null</code>.
     */
     ...
     * <code>null</code>.
     *
     * @return The model from the POM file, never
     * <code>null</code>.
     *
     ...
     *
     * @return The path to the generated POM file, never
     * <code>null</code>.
     *
